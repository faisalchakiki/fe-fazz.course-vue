                ...
                <div
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                        <button
                            @click="handleEdit"
                            type="button"
                            class="inline-flex w-full justify-center rounded-md bg-success px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-succes/70 sm:ml-3 sm:w-auto">Deactivate</button>
                        <button
                            @click="showModal"
                            type="button"
